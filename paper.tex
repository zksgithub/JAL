...
This study is motivated by three observations concerning the intersection of oral history curation and computational assessment. First, oral history collections lack standardized, reproducible quality benchmarks. Unlike bibliographic metadata---where completeness, accuracy, and consistency are routinely measured through automated validation---oral testimonies are assessed almost exclusively through qualitative human judgment. Without computable metrics, libraries cannot compare collections, allocate curation resources systematically, or demonstrate collection value to stakeholders in quantitative terms.

Second, the complementary relationship between special collections and public knowledge graphs remains unquantified. Wikidata and similar platforms have achieved remarkable breadth in identity resolution, but their coverage of domain-specific relational data---mentorship, informal collaboration, tacit institutional knowledge---is largely unknown. Libraries invest substantial resources in building special collections that may already be partially covered by public data, or conversely, may hold uniquely valuable content whose scarcity is invisible without systematic comparison.

Third, the enrichment loop between special collections and public knowledge graphs lacks an evaluative framework. When libraries contribute extracted data to Wikidata, the impact on collection quality---measured through before-and-after indicator comparison---has not been studied. Moreover, after enrichment, the content that remains absent from public sources constitutes the collection's irreplaceable core: personal reflections that are never formally published, tacit knowledge of experimental failures communicated only through oral tradition, and informal mentor networks documented only in personal chronologies. Identifying this residual scarcity is essential for justifying continued investment in oral history curation.
...
\begin{enumerate}[label=RQ\arabic*:,leftmargin=*]
    ...
    \item Does enrichment with public data improve collection quality metrics, and what residual gaps---the uniquely scarce content that no public source can fill---justify further curatorial follow-up?
\end{enumerate}

This study makes three contributions aligned with the above motivations. Collectively, they transform oral history special collections from a posture of passive acceptance—where libraries receive and catalog materials as they arrive—to a model of proactive, computationally-driven assessment and further mining.

\textbf{C1: A computable quality indicator system for oral history collections.} We propose and validate five indicators---Uncertainty Density (UD), Memory Bias Index (MBI), Cross-Reference Connectivity (CRC), Narrative Arc Type (NAT), and Wikidata Enrichment Ratio (WER)---that provide the first standardized, reproducible benchmarks for oral history special collections. These metrics operationalize narrative quality, uncertainty, memory bias, cross-collection connectivity, and Wikidata complementarity as quantitative, auditable measures.

\textbf{C2: Empirical quantification of the complementarity gap.} Through comparison with a full 142~GB Wikidata dump, we measure the gap between a curated oral history corpus and the largest public knowledge graph, finding a 36.8$\times$ Wikidata Enrichment Ratio (WER) and zero relational coverage---mentorship, collaboration, and biographical events are entirely absent from Wikidata for this cohort. To our knowledge, this is the first systematic measurement of oral history--public knowledge graph complementarity for a scientist cohort.

\textbf{C3: A closed-loop enrichment framework with residual scarcity identification.} We demonstrate the full curation cycle---assess (MI1--MI5) $\rightarrow$ enrich (Wikidata publication) $\rightarrow$ re-assess (post-enrichment indicators) $\rightarrow$ follow up---and identify three categories of irreducibly scarce content that remain absent from public sources even after maximum enrichment: personal reflections that are never formally published, tacit knowledge of experimental failures communicated only through oral tradition, and informal mentor networks documented only in personal chronologies. This framework replaces the traditional model in which special collections passively receive materials with one in which libraries actively evaluate, enrich, and mine their oral history assets---turning collection assessment from a one-time curatorial step into an iterative, computationally-driven process.
